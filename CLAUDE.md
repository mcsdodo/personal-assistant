...
├── subagents: email-classifier (haiku), scan-classifier (haiku), document-processor (haiku)
...
| `local/claude-code/agents/` | Haiku subagents (email-classifier, scan-classifier, document-processor) |
